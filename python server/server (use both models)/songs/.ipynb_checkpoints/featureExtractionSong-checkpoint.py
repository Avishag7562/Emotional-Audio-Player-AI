...
#         valid_extensions = ['.mp3', '.wav']  # Add more extensions if needed
...
#                     extracted_features = extract_single_audio_features(file_path)
#                     feature_set = pd.concat([feature_set, extracted_features], ignore_index=True)
